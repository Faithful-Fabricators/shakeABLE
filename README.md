...
+──────────────────────────────────────────────────────────+│               4S NiMH Battery Pack (4.8V)                │+───────────────┬────────────────────────┬─────────────────+│ (+)                    │ (-)[Power Switch]                 ││                        │├───┐                    ││   │                    ││   ▼                    ▼│  ┌───────────────────────┐│  │   COMMON GND BUS      ││  └─┬───┬───┬─────────┬───┘│    │   │   │         │▼    ▼   │   │         │┌──────────┐ │   │         ││  5V Pin  │ │   │         ││  GND     ├─┘   │         ││  Pin D9  ├──┐  │         ││  Pin D2  ├┐ │  │         ││  Pin A0  ├┼─┼──┼──┐      │└──────────┘│ │  │  │      │ARDUINO NANO│ │  │  │      ││ │  │  │      │┌───────────────────────┘ │  │  │      ││                         ▼  │  │      ││                  ┌────────┐│  │      ││                  │Red(V+) ││  │      │└─────────────────►│Yel(Sig)││  │      ││Brn(GND)├┘  │      │└────────┘   │      │MG995 SERVO  │      ││      │┌───────────────────────────────┘      │▼                                      ▼┌──────────────────────┐             ┌─────────┐│  3.5mm STEREO JACK   │             │ 10k POT │├──────────────────────┤             ├─────────┤│ Tip ◄──[100Ω Resist]─┼────────┐    │ Center  │──► Nano A0│ Ring  ◄──────────────┼──────┐ │    │ Left    │──► Common GND│ Sleeve ◄─────────────┴──────┴─┼───►│ Right   │──► Nano 5V└───────────────────────────────┘    └─────────┘


*Note: Tying the Ring and Sleeve together on the cheap stereo jack allows the use of standard mono adaptive switches. A **100Ω safety resistor** is added to the Tip line to eliminate the risk of a dead short if an unexpected stereo cable is plugged in while powered on.*
